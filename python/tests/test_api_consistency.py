...
def filter_and_normalize(
    functions: Dict[str, Set[str]], exclude: Set[str], normalize: Callable = None
) -> Dict[str, Set[str]]:
...
def compare_function_sets(
    ...
    filtered_async = filter_and_normalize(
        async_functions, set(excluded_functions["async_only"])
    )
    filtered_sync = filter_and_normalize(
...
class TestConsistency:
    ...
    def test_tests_consistency(self):
        compare_function_sets(
            ...
            normalize_sync=normalize_test_name,
        )
